...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, MT(MOD_LGUI, KC_A),MT(MOD_LALT, KC_S),MT(MOD_LCTL, KC_D),MT(MOD_LSFT, KC_F),MT(MOD_RALT, KC_G),TG(7),          KC_TRANSPARENT, MT(MOD_RALT, KC_H),MT(MOD_RSFT, KC_J),MT(MOD_RCTL, KC_K),MT(MOD_LALT, KC_L),MT(MOD_RGUI, KC_SCOLON),KC_TRANSPARENT,
    KC_TRANSPARENT, KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                                          KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LT(6,KC_DELETE),                KC_TRANSPARENT,                KC_TRANSPARENT,                 LT(4,KC_ESCAPE),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [1] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_LGUI,        KC_LALT,        KC_LCTRL,       KC_LSHIFT,      KC_RALT,        KC_TRANSPARENT,                KC_TRANSPARENT, KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_CAPSLOCK,    KC_TRANSPARENT,
  ...
  [2] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, UK_GRV,         KC_4,           KC_5,           KC_6,           KC_EQUAL,       KC_TRANSPARENT,                KC_TRANSPARENT, KC_LALT,        KC_RSHIFT,      KC_RCTRL,       KC_LALT,        KC_RGUI,        KC_TRANSPARENT,
  ...
  [3] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, UK_NOT,         UK_DLR,         UK_PERC,        UK_CIRC,        UK_PLUS,        KC_TRANSPARENT,                KC_TRANSPARENT, KC_LALT,        KC_RSHIFT,      KC_RCTRL,       KC_LALT,        KC_RGUI,        KC_TRANSPARENT,
    KC_TRANSPARENT, UK_TILD,        KC_EXLM,        UK_DQUO,        UK_PND,         UK_PIPE,                                                       KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT,
  ...
  [4] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_F11,         KC_F4,          KC_F5,          KC_F6,          KC_APPLICATION, KC_TRANSPARENT,                KC_TRANSPARENT, KC_LALT,        KC_RSHIFT,      KC_RCTRL,       KC_LALT,        KC_RGUI,        KC_TRANSPARENT,
  ...
  [5] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_LGUI,        KC_LALT,        KC_LCTRL,       KC_LSHIFT,      KC_RALT,        KC_TRANSPARENT,                KC_TRANSPARENT, KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_UP,       KC_MS_RIGHT,    KC_NO,          KC_TRANSPARENT,
  ...
  [6] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_LGUI,        KC_LALT,        KC_LCTRL,       KC_LSHIFT,      KC_RALT,        KC_TRANSPARENT,                KC_TRANSPARENT, KC_MEDIA_PREV_TRACK,KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_MEDIA_NEXT_TRACK,KC_NO, KC_TRANSPARENT,
