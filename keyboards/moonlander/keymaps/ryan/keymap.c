...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  // base
  [0] = LAYOUT_moonlander(
    XXXXXXX,        KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           TG(3),                         TG(5),          KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           XXXXXXX,
    XXXXXXX,        KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           TG(2),                         XXXXXXX,        KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           XXXXXXX,
  ...
  [1] = LAYOUT_moonlander(
    ...
    XXXXXXX,        KC_INS,         XXXXXXX,        KC_BRID,        KC_BRIU,        KC_PSCR,        XXXXXXX,                       XXXXXXX,        _______,        KC_HOME,        KC_END,         KC_LBRC,        KC_RBRC,        KC_F12,
    XXXXXXX,        KC_SCRL,        KC_MPRV,        KC_VOLD,        KC_VOLU,        KC_MNXT,        _______,                       XXXXXXX,        KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_MINUS,       KC_EQUAL,
    XXXXXXX,        KC_PAUS,        KC_MSTP,        KC_MPLY,        KC_MUTE,        XXXXXXX,                                                       _______,        KC_PGUP,        KC_PGDN,        KC_APP,         CW_TOGG,        KC_CAPS_LOCK,
  ...
  [2] = LAYOUT_moonlander(
    ...
    XXXXXXX,        _______,        _______,        _______,        _______,        _______,        XXXXXXX,                       XXXXXXX,        XXXXXXX,        KC_4,           KC_5,           KC_6,           _______,        _______,
    XXXXXXX,        _______,        _______,        _______,        _______,        _______,                                                       XXXXXXX,        KC_1,           KC_2,           KC_3,           KC_SLSH,        XXXXXXX,
    XXXXXXX,        _______,        _______,        _______,        _______,                        _______,                       _______,                        KC_0,           KC_COMMA,       KC_DOT,         S(KC_8),        XXXXXXX,
  ...
  [3] = LAYOUT_moonlander(
    ...
    XXXXXXX,        _______,        _______,        _______,        _______,                        _______,                       _______,                        XXXXXXX,        XXXXXXX,        XXXXXXX,        XXXXXXX,        XXXXXXX,
